      ...
      <div className="container">
        <div className={DataStyle.our_data_wrap}>
          <div className={DataStyle.data_wrap}>
            <img src="/images/brands-work-icon.webp" alt="brand-work-icon" />
          ...
          <div className={DataStyle.data_wrap}>
            <img src="/images/influ-earn-icon.webp" alt="brand-work-icon" />
            <div className={DataStyle.info_wrap}>
          ...
          <div className={DataStyle.data_wrap}>
            <img src="/images/camp-del-icon.webp" alt="brand-work-icon" />
            <div className={DataStyle.info_wrap}>
            <h2><Number n ={95}/>%</h2>
